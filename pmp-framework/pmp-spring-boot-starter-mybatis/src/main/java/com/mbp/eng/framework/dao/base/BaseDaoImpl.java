package com.mbp.eng.framework.dao.base;
 ...
 * @param <K> 主键
 */
public abstract class BaseDaoImpl<T, K extends Serializable> extends MyBatisSupport implements BaseDao<T, K> {
    ...
    public List<T> selectEntryList(K... key) {
