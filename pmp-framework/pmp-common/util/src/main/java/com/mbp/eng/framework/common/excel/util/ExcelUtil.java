...
import com.mbp.eng.framework.common.excel.model.ExcelColumn;
...
//                FileInputStream is = new FileInputStream(new File(path));
    ...
    public static <T> void writeExcel(HttpServletResponse httpServletResponse, List<T> dataList, Class<T> tClass) {
        ...
        //浏览器下载excel
        buildExcelDocument("abbot.xlsx", workbook, httpServletResponse);
        //生成excel文件
        //buildExcelFile(".\\default.xlsx",workbook);
    }
    ...
    private static void buildExcelDocument(String fileName, Workbook workbook, HttpServletResponse httpServletResponse) {
        try {
