package com.mbp.eng.framework.common.util.ip;
...
public class IPToolUtils {
     ...
     * @param name    请求参数,请求参数应该是 name1=value1&name2=value2 的形式.
     * @return 所代表远程资源的响应结果
     */
    ...
    public static void doPost(String url, String name, String pwd, String phone, String content) {
        ...
        try {
            ...
            System.out.println("executing httpServletRequest " + httppost.getURI());
