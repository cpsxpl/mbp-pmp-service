...
public class ProjectFileController {
    @Autowired
    private IProjectFileService adminFileService;
    ...
    public Result deleteByBatchId(@io.swagger.v3.oas.annotations.parameters.RequestBody AdminDeleteByBatchIdBO requestBO) {
