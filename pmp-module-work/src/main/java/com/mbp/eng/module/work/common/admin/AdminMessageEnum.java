package com.mbp.eng.module.work.common.admin;
...
public enum AdminMessageEnum {
    ...
    public static AdminMessageEnum parse(int type) {
        for (AdminMessageEnum adminMessageEnum : AdminMessageEnum.values()) {
            if (adminMessageEnum.getType() == type) {
                return adminMessageEnum;
            }
        }
        return NULL;
    }
    ...
    public static AdminMessageEnum parse(String remarks) {
        for (AdminMessageEnum adminMessageEnum : AdminMessageEnum.values()) {
            if (adminMessageEnum.getRemarks().equals(remarks)) {
                return adminMessageEnum;
            }
        }
        return NULL;
