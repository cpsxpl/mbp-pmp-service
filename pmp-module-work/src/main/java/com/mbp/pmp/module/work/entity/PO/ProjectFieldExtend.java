package com.mbp.pmp.module.work.entity.PO;
...
@TableName("wk_project_field_extend")
@ApiModel(value = "ProjectFieldExtend对象", description = "自定义字段扩展数据表")
public class ProjectFieldExtend implements Serializable {
